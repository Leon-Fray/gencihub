...
-- Run this in your Supabase SQL Editor to create both account_requests and links tables
...
-- SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('account_requests', 'links');
-- SELECT tablename, policyname FROM pg_policies WHERE tablename IN ('account_requests', 'links');
